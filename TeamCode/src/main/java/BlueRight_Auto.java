...
@Autonomous
public class BlueRight_Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        fl.setTargetPosition(20);
        fr.setTargetPosition(20);
        bl.setTargetPosition(20);
        br.setTargetPosition(20);
        ...
        while (carousel.getCurrentPosition() < carousel.getTargetPosition()) {
        ...
        fl.setTargetPosition(2650);
        fr.setTargetPosition(2650);
        bl.setTargetPosition(2650);
        br.setTargetPosition(2650);
